...
const BODY_PARTS = {
  ...
  truck: '<rect x="18" y="18" width="44" height="34"/>',
...
const DETAIL = {
  ...
  truck: '<path d="M0 52V40l3-3.5h8.5L15 30h3v22z"/><circle cx="6" cy="59" r="4.4"/><circle cx="23" cy="59" r="4.4"/><circle cx="45" cy="59" r="4.4"/><circle cx="55" cy="59" r="4.4"/><path d="M18 54h44"/>',
