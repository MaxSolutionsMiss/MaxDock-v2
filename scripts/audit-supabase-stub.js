...
(() => {
  ...
  const ALL_PERMISSIONS = ['ai.insights', 'appointment.assign', 'appointment.cancel', 'appointment.cancel_own', 'appointment.complete', 'appointment.create', 'appointment.delete', 'appointment.update', 'appointment.view', 'appointment.view_own', 'audit.view', 'block.manage', 'dock.manage', 'dock.view', 'location.manage', 'location.view', 'notifications.view', 'operations.queue.view', 'reports.view', 'reports.view_labour', 'reports.view_dock_hours', 'reports.view_fullness', 'reports.view_overview', 'reports.view_scorecard_company', 'reports.view_scorecard_location', 'reports.view_skid_movement', 'reports.view_truck_flow', 'settings.manage', 'settings.manage_labour', 'settings.view', 'system.manage', 'user.manage', 'user.view', 'appointment.check_in'];
  ...
  const OTHER_ROLE_PERMISSIONS = {
    site_admin: ['ai.insights', 'appointment.assign', 'appointment.cancel', 'appointment.cancel_own', 'appointment.complete', 'appointment.create', 'appointment.update', 'appointment.view', 'appointment.view_own', 'audit.view', 'block.manage', 'dock.manage', 'dock.view', 'location.view', 'notifications.view', 'operations.queue.view', 'reports.view', 'reports.view_labour', 'reports.view_dock_hours', 'reports.view_fullness', 'reports.view_overview', 'reports.view_scorecard_company', 'reports.view_scorecard_location', 'reports.view_skid_movement', 'reports.view_truck_flow', 'settings.manage', 'settings.manage_labour', 'settings.view', 'user.manage', 'user.view', 'appointment.check_in'],
    shipping_manager: ['ai.insights', 'appointment.assign', 'appointment.cancel', 'appointment.cancel_own', 'appointment.complete', 'appointment.create', 'appointment.update', 'appointment.view', 'appointment.view_own', 'audit.view', 'block.manage', 'dock.view', 'location.view', 'notifications.view', 'operations.queue.view', 'reports.view', 'reports.view_labour', 'reports.view_dock_hours', 'reports.view_fullness', 'reports.view_overview', 'reports.view_scorecard_company', 'reports.view_scorecard_location', 'reports.view_skid_movement', 'reports.view_truck_flow', 'settings.manage_labour', 'settings.view', 'appointment.check_in'],
    customer: ['appointment.cancel_own', 'appointment.create', 'appointment.view_own', 'location.view', 'notifications.view'],
    // Re-read off the live table. This one had drifted: it was missing reports.view and the five
    // report views underneath it, so the role-access window drew a Coordinator who could not open
    // Reports at all — and the walk that hides Reports from a Coordinator was hiding a link that
    // was never there. A fixture claiming to be a copy has to actually be one.
    coordinator: ['ai.insights', 'appointment.assign', 'appointment.cancel_own', 'appointment.check_in', 'appointment.complete', 'appointment.create', 'appointment.update', 'appointment.view', 'appointment.view_own', 'audit.view', 'dock.view', 'location.view', 'notifications.view', 'operations.queue.view', 'reports.view', 'reports.view_dock_hours', 'reports.view_fullness', 'reports.view_overview', 'reports.view_skid_movement', 'reports.view_truck_flow'],
  };
  const TABLE = {
    ...
    permissions: [
      ...
      ['reports.view_overview', 'Reports: Overview'], ['reports.view_truck_flow', 'Reports: Truck flow'],
      ['reports.view_skid_movement', 'Reports: Skid movement'], ['reports.view_dock_hours', 'Reports: Dock hours'],
      ['reports.view_scorecard_company', 'Reports: Vendor scorecard'], ['reports.view_scorecard_location', 'Reports: Site scorecard'],
      ['reports.view_fullness', 'Reports: Truck fullness'],
